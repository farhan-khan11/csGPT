...
export function BoltStyleChat({
    ...
    const handleSend = async (msg) => {
        ...
        if (!onSend) {
            console.log("onsend not received ! ")
            return
        }
    ...
    return (
        <div className="relative flex flex-col min-h-screen w-full overflow-hidden bg-[#0f0f0f]">
            ...
            {/* INITIAL SCREEN */}
            {!started && (
                <div className="absolute top-[66%] left-1/2 sm:top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center w-full px-4">
                            ...
                            if (msg.role === "user") {
                                return (
                                    <div key={i} className="flex justify-end w-full">
                                        <div className="bg-[#1488fc] text-white px-4 py-2 rounded-xl max-w-[70%]">
                                            {msg.content}
                                        </div>
                                    </div>
                                )
                            ...
                            if (msg.role === "ai") {
                                return (
                                    <div key={i} className="flex justify-start w-full">
                                        <div className="bg-[#1e1e22] text-white border border-white/10 px-4 py-2 rounded-xl max-w-[70%]">
                                            {msg.content}
                                        </div>
                                    </div>
                                )
